...
{
	[CreateAssetMenu(fileName = "aom_newAverageOverlapsMode", menuName = "Scriptable Object/Aim Assist/OverlapResolutionMode/AverageOverlapsMode")]
	public class AverageOverlapsMode : OverlapResolutionMode
	{
		/// <summary>
		/// Mutates the given inputs, and resolves overlaps by averaging the conflicting inputs and outputs.
		/// </summary>
